...
If you want to check the integrity of your grf or check wether your self-compiled grf is the the same as it should, have a look at {{OBG_FILE}}
...
3. Place the tar file into the OpenTTD /data directory. There's no need to unpack the tar, so just leave it as it is. Your OpenTTD /data directory is either located in: 
...
The OpenGFX source is available in a Mercurial repository. You can do an anonymous checkout from http://mz.openttdcoop.org/hg/opengfx , e.g. using 
