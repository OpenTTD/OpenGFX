# OpenGFX - 8bpp Graphics Base Set for OpenTTD



## Contents

- 1 [About OpenGFX](#1-about-opengfx)
- 2 [Downloading OpenGFX](#2-downloading-opengfx)
- 3 [Installing OpenGFX](#3-installing-opengfx)
...
- 4 [Reporting bugs and contributing](#4-reporting-bugs-and-contributing)
...
This method uses the [Online content service (BaNaNaS)](https://bananas.openttd.org/en/) to download OpenGFX. In order to use this OpenGFX version, you need a working OpenTTD and again at least OpenTTD version 1.2.0 or a recent nightly.
...
The OpenGFX source is available on a git repository or as a compressed file. You can do an anonymous checkout using `git clone https://github.com/OpenTTD/OpenGFX.git` or obtain the zip file or tarball from the [release page](https://github.com/OpenTTD/OpenGFX/releases).
...
On Linux: your system should already have most tools, you'll probably only need NML and git available from the source mentioned above. For installation instructions concerning git refer to the manual of your distribution.
...
Copyright (C) 2007-2016 by the OpenGFX team (see [credits section](#6-credits) below)
