...
GRF_BUILDNAME= $(shell [ -n "$(REPO_TAGS)" ] && echo $(REPO_TAGS)-$(GRF_MODIFIED) || echo $(GRF_RELEASE)-r$(GRF_REVISION)$(GRF_MODIFIED))

GRF_TITLE    = $(GRF_NAME) $(GRF_VERSION) $(GRF_BUILDNAME)
TAR_FILENAME = $(GRF_NAME)-$(GRF_VERSION)-$(GRF_BUILDNAME).tar
